 ...
 * تم التحديث: توحيد دوال showToast, formatNumber, formatDate من admin-utils.js
 */
...
(function() {
    ...
    const CoreUtils = {
        ...
        /**
         * تحويل التاريخ إلى صيغة عربية (مدمجة من admin-utils.js)
         */
        ...
        /**
         * إظهار إشعار (مدمجة من admin-utils.js)
         */
    ...
    window.formatArabicDate = CoreUtils.formatDate; // استخدام formatDate الموحدة
