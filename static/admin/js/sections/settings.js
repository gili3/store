            ...
            <div class="settings-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 25px;">
                ...
                <div class="settings-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="storeName" placeholder="${siteSettings.storeName || 'Eleven Store'}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="storeEmail">البريد الإلكتروني للمتجر</label>
                        <input type="email" id="storeEmail" placeholder="${siteSettings.storeEmail || 'info@eleven.com'}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="storePhone">رقم هاتف المتجر</label>
                        <input type="text" id="storePhone" placeholder="${siteSettings.storePhone || '0912345678'}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="storeCurrency">العملة</label>
                        <input type="text" id="storeCurrency" placeholder="${siteSettings.storeCurrency || 'SDG'}" class="form-control">
                    </div>
                </div>
                ...
                <div class="settings-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="shippingCost" placeholder="${siteSettings.shippingCost || '0'}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="freeShippingLimit">حد الشحن المجاني</label>
                        <input type="number" id="freeShippingLimit" placeholder="${siteSettings.freeShippingLimit || '0'}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="shippingEstimatedDays">مدة التوصيل المتوقعة</label>
                        <input type="text" id="shippingEstimatedDays" placeholder="${siteSettings.shippingEstimatedDays || '2-4 أيام'}" class="form-control">
                    </div>
                    <div class="form-group" style="margin-top: 15px;">
                        <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                            <input type="checkbox" id="enableCashOnDelivery" ${siteSettings.enableCashOnDelivery ? 'checked' : ''}> تفعيل الدفع عند الاستلام
                        </label>
                    </div>
                </div>
                ...
                <div class="settings-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="bankName" placeholder="${siteSettings.bankName || 'بنك الخرطوم'}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="bankAccount">رقم الحساب</label>
                        <input type="text" id="bankAccount" placeholder="${siteSettings.bankAccount || '1234567'}" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="bankAccountName">اسم صاحب الحساب</label>
                        <input type="text" id="bankAccountName" placeholder="${siteSettings.bankAccountName || 'Eleven Store'}" class="form-control">
                    </div>
                </div>
                ...
                <div class="settings-section">
                    ...
                    <div class="form-group">
                        <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                            <input type="checkbox" id="maintenanceMode" ${siteSettings.maintenanceMode ? 'checked' : ''}> تفعيل وضع الصيانة
                        </label>
                    </div>
                    <div class="form-group">
                        <label for="maintenanceMessage">رسالة الصيانة</label>
                        <textarea id="maintenanceMessage" rows="3" class="form-control" placeholder="${siteSettings.maintenanceMessage || 'الموقع تحت الصيانة حالياً...'}"></textarea>
                    </div>
                </div>
            </div>
...
/**
 * دالة حفظ الإعدادات عبر API السيرفر
 */
async function saveSettings(event) {
    ...
    try {
        ...
        let logoUrl = siteSettings.logoUrl || siteSettings.logo;
        ...
        // تحديث الإعدادات عبر السيرفر (PATCH /api/settings)
        await window.apiClient.request('/settings', {
            method: 'PATCH',
        ...
        if (window.AppState) AppState.setSettings(siteSettings);
