...
window.checkAdmin = function() {
    ...
    // 3. محاولة أخيرة: التحقق من البيانات المخزنة محلياً
    ...
    // تم تعطيل إعادة التوجيه للتجربة
    console.warn('⚠️ [DEBUG MODE] تم تجاوز التحقق من الصلاحيات');
    return true; // السماح بالدخول دائماً للتجربة
